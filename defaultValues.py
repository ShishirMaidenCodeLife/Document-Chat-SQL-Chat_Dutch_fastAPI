...
# Our folder for storing database
...
ED_TRANSLATOR_DIRECTORY = f"{ROOT_DIRECTORY}/EnglishToDutchModel"

MODELS_PATH = "./models"

# The value can be changed to a specific number
...
MODEL_ID2="TheBloke/Llama-2-7b-Chat-GPTQ"
MODEL_BASENAME = "model.safetensors"

MODEL_ID3 = "TheBloke/Llama-2-7b-Chat-GGUF"
MODEL_BASENAME3 = "llama-2-7b-chat.Q4_K_M.gguf"


# MODEL_ID =  os.path.join(ROOT_DIRECTORY, "Mymodel/Llama2")
